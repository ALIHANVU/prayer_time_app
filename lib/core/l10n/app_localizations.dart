...
const ceStrings = AppStrings(
  appTitle: 'Ламазан Хан', today: 'ТАХАНА', timeRemaining: '-',
  completed: '-', active: '-',
  sunriseTitle: '(Шурук)', sunriseSubtitle: 'Ламаз деша йиш йоцу хан',
  scheduleTitle: 'ЛАМАЗАНИЙН ХЕНАШ', nextPrayer: '-',
  home: 'Коьрта', qibla: 'Кьибла', profile: 'Хаамаш',
  fajr: 'Iуьйра-ламаз', dhuhr: 'Делкъа-ламаз', asr: 'Малхбуза-ламаз',
  maghrib: 'Маьрк1ажа-ламаз', isha: 'Пхьуъйра-ламаз',
);
