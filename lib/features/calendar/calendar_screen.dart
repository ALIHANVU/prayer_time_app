...
/// Экран месячного календаря намазов.
/// Показывает таблицу с временем всех намазов на каждый день месяца.
...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  String _cleanTime(String time) {
    return time.split(' ').first.trim(); // Убираем "(EET)" и т.п.
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Календарь', style: AppTextStyles.heading),
        ...
        child: SingleChildScrollView(
          ...
          child: DataTable(
            ...
            columns: const [
              ...
              DataColumn(label: Text('Фаджр')),
              DataColumn(label: Text('Восход')),
              DataColumn(label: Text('Зухр')),
              DataColumn(label: Text('Аср')),
              DataColumn(label: Text('Магриб')),
              DataColumn(label: Text('Иша')),
            ],
            rows: _days!.map((day) {
