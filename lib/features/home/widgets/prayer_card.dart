...
class _PrayerCardState extends State<PrayerCard>
  ...
  // Анимация нажатия (scale down на 97%)
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.status) {
      ...
      case PrayerStatus.active:
        ...
        iconColor = zc;
        timeColor = zc;
        statusText = '• ${PrayerCalculator.getZoneName(widget.currentZone)}';
        break;
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        _pressCtrl.reverse();
        // ═══ ВИБРАЦИЯ: нажатие на карточку намаза ═══
