...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final activeName =
    activeIdx >= 0 ? strings.prayerName(prayers[activeIdx].id) : '—';
          ...
          children: [
            ...
            _StaggerEntry(
              ...
              child: _buildProgressCircle(
                ...
                animatedProgress, zone, zoneColor, activeIdx, strings,
              ),
            ),
            const SizedBox(height: 12),
            _StaggerEntry(delay: 240, child: _buildZoneLegend(zone, strings)),
            const SizedBox(height: 20),
            ...
            ...List.generate(prayers.length, (i) => _StaggerEntry(
              ...
              child: Padding(
                ...
                child: PrayerCard(
                  ...
                  localizedName: strings.prayerName(prayers[i].id),
                ),
              ),
            )),
  ...
  Widget _buildDateCard(AppStrings strings) {
    ...
    return Center(child: Container(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 4),
        Text(
          '${strings.weekdayName(_now.weekday)}, ${_now.day} ${strings.monthNameOf(_now.month)} ${_now.year}',
  ...
  Widget _buildProgressCircle(String prayerName, String timeRemaining,
      ...
      int activeIdx, AppStrings strings) {
    ...
    // Локализованное название зоны
    String zoneName;
    switch (zone) {
      case PrayerZone.fadila:
        zoneName = strings.zoneFadila;
        break;
      case PrayerZone.permissible:
        zoneName = strings.zonePermissible;
        break;
      case PrayerZone.makruh:
        zoneName = strings.zoneMakruh;
        break;
      case PrayerZone.expired:
        zoneName = strings.zoneMissed;
        break;
    }
  ...
  Widget _buildZoneLegend(PrayerZone currentZone, AppStrings strings) {
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      _zoneDot(AppColors.fadila, strings.zoneFadila,
          currentZone == PrayerZone.fadila),
      const SizedBox(width: 16),
      _zoneDot(AppColors.permissible, strings.zonePermissible,
          currentZone == PrayerZone.permissible),
      const SizedBox(width: 16),
      _zoneDot(AppColors.makruh, strings.zoneMakruh,
          currentZone == PrayerZone.makruh),
    ]);
  }
