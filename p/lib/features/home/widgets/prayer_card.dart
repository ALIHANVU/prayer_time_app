  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
            ...
            child: Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
                child: Row(children: [
                  ...
                  Container(width: 40, height: 40,
                      ...
                      child: Text(_prayerEmoji(widget.prayer.id), style: const TextStyle(fontSize: 20))),
        ...
        SizeTransition(sizeFactor: _expandAnim, child: _buildDetail(isDark, s)),
      ]),
    );
  }
    ...
    return Container(
        ...
        child: Row(children: [
          Container(width: 36, height: 36,
              ...
              alignment: Alignment.center,
              child: Text(item.isFard ? '🕋' : '🕌', style: const TextStyle(fontSize: 18))),
          const SizedBox(width: 10),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
